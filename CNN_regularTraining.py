...
if __name__ == '__main__': 
    ...
    # balancedDataset = None
 
    # balancedDataset_labels = []
    ...
    #         if len(newLabelCheck) == 2: 
    #             balancedDataset_labels.append(0)
    #         else: 
    #             balancedDataset_labels.append(1)
...
#    dataset = dataset / 255.0 
    ...
    #     np.save(f, balancedDataset_labels)
    ...
    for i in range(25): 
        ...
        if i == 0:
            ...
            for i in range(25):
                ...
                np_index = balancedDatasetLabelsIndex[nextImage[i]-i]
                
                np_index = np.expand_dims(np_index, axis=0)
  ...
  #      tempTrainingSet = training_set[mask]
   ...
   #     tempTrainingSetLabels = training_set_labels[mask]
    ...
    #    print(tempTrainingSetLabels) 
        ...
        print("TRAINING SET INDEX", training_set_index)
        ...
        if trueLabels.shape[0] != 0 and falseLabels.shape[0] != 0: 
            ...
            while training_true.shape[0] != training_false.shape[0]: 
                ...
                newTrainingIndex = np.expand_dims(trueLabels[i], axis=0) 
    ...
    plt.legend()
    plt.show()
    plt.savefig("TrainingValidationLoss_ActiveLearning.png")
    ...
    plt.legend()
    plt.show()
    plt.savefig("TrainingTestingAccuracy_ActiveLearning.png")
    ...
    plt.legend() 
    plt.show() 
    plt.savefig("SpecificitySensitivityACcuracy_ActiveLearning.png")
